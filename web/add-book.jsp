                    ...
                    <form method="Post" action="Book?action=<%="add"%>">
                        <div class="form-row profile-row">
                            <div class="col-md-8">
                                ...
                                <div
                                    class="form-group"><label style="color: rgb(31,40,81);font-size: 16px;font-weight: bold;">No of Copies</label><input name="no_of_copies" class="form-control" type="number" style="border-color: rgb(31,40,81);"></div>
