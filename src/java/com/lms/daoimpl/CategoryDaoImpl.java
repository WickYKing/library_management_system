...
//	Connection conn = Database.getConnection();
    ...
    public Integer addCategory(Category category) {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement("INSERT INTO public.category(category,create_date,created_by,status) VALUES(?,?,?,1)");
    ...
    public Integer updateCategory(Category category) {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement("UPDATE public.category SET category=?,update_date=?,updated_by=? WHERE id=?");
            pstmt.setString(1, category.getCategory());
    ...
    public Integer deleteCategory(Integer id) {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement("UPDATE public.category SET status=0 WHERE id=?");
            pstmt.setInt(1, id);
    ...
    public Integer getIdByName(String name) {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement("SELECT id FROM public.category WHERE category=? and status > 0");
    ...
    public Category getCategoryById(Integer id) {
        ...
        if (id != null) {
            try {
                ...
                PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM public.category WHERE id=? and status > 0");
                pstmt.setInt(1, id);
    ...
    public List<Category> getAllCategory() {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM public.category WHERE status = 1");
