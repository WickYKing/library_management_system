...
//	Connection conn = Database.getConnection();
    ...
    public Integer addRole(Role role) {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement("INSERT INTO public.role(role,create_date,created_by,status) VALUES(?,?,?,1)");
    ...
    public Integer updateRole(Role role) {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement("UPDATE public.role SET role=?,update_date=?,updated_by=? WHERE role_id=?");
            pstmt.setString(1, role.getRole());
    ...
    public Integer deleteRole(Integer roleId) {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement("UPDATE public.role SET status=0 WHERE role_id=?");
    ...
    public Role getRoleById(Integer id) {
        ...
        if (id != null) {
            try {
                ...
                PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM public.role WHERE role_id=? and status=1");
                pstmt.setInt(1, id);
    ...
    public Integer getRoleIdByName(String name) {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM public.role WHERE role=? and status>0");
    ...
    public List<Role> getAllRole() {
        ...
        try {
            PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM public.role WHERE status>0");
